/** Profile + Settings Modules — profile, sessions, theme, delete account */
...
// ── Services ──
export const profileKeys = { me: () => ['me'] as const, sessions: () => ['me', 'sessions'] as const, prefs: () => ['me', 'prefs'] as const };
